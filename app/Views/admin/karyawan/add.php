...
<div class="card-box table-responsive">
    <div class="row">
        ...
        <?php endif ?>
        <div class="col-md-6">
            <form class="form-horizontal" action="<?= site_url('admin/karyawan/store') ?>" method="POST">
                <div class="form-group">
                    <label class="col-md-2 control-label">NIP</label>
                    <div class="col-md-10">
                        <!-- <input type="text" class="form-control" name="nip" placeholder="NIP" required> -->
                        <input type="text" placeholder="" data-mask="99999999 999999 9 999" name="nip" value="<?= set_value('nip') ?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-2 control-label">Nama</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="nama" placeholder="Nama" value="<?= set_value('nama') ?>" required>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="radio radio-info radio-inline" bis_skin_checked="1">
                            <input type="radio" id="jenis_kelamin1" value="l" name="jenis_kelamin" required>
                            <label for="jenis_kelamin1"> Laki-laki </label>
                        </div>
                        <div class="radio radio-info radio-inline" bis_skin_checked="1">
                            <input type="radio" id="jenis_kelamin2" value="p" name="jenis_kelamin" required>
