    ...
    <div class="col-xs-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb p-0 m-0">
                <li>
                    <a href="<?= site_url('kepsek/dashboard') ?>">Kepsek</a>
                </li>
                <li>
                    Laporan
                </li>
...
<div class="card-box table-responsive">
    <div class="row m-b-10">
        <div class="col-sm-6" bis_skin_checked="1">
            <form class="form-inline" id="formGajiFilter" action="<?= site_url('kepsek/laporan/cetak') ?>" method="POST">
...
$(document).ready(function() {
    table = $('#datatable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?= site_url('/kepsek/laporan/get-laporan-json') ?>',
            type: 'POST',
            data: function(data) {
